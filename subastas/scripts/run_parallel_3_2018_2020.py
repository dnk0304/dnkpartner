#!/usr/bin/env python3
"""
Parallel Scraper 3: 2018-2020 (Backfill)
...
def setup_logging():
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler(
                project_root / 'scraper' / 'parallel_3_2018_2020.log',
                encoding='utf-8',
            ),
        ],
    )
...
def main():
    ...
    print("=" * 70)
    print("PARALLEL SCRAPER 3: 2018-2020 (BACKFILL)")
    print("=" * 70)
    print("Date Range: 2018-01-01 to 2019-12-31")
    ...
    try:
        ...
        print()
        print("=" * 70)
        print("✓ SCRAPER 3 COMPLETE (2018-2020)")
        print("=" * 70)
