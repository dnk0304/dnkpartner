...
def setup_logging():
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler(
                project_root / 'scraper' / 'parallel_1_2016_2018.log',
                encoding='utf-8',
            ),
        ],
    )
...
def main():
    ...
    print("=" * 70)
    print("PARALLEL SCRAPER 1: 2016-2018")
    print("=" * 70)
    print("Date Range: 2016-01-01 to 2017-12-31")
    ...
    try:
        progress = scraper.scrape_date_range(
            start_year=2016, start_month=1, start_day=1,
        ...
        print()
        print("=" * 70)
        print("✓ SCRAPER 1 COMPLETE (2016-2018)")
        print("=" * 70)
