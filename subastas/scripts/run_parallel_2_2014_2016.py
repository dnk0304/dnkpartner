...
def setup_logging():
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler(
                project_root / 'scraper' / 'parallel_2_2014_2016.log',
                encoding='utf-8',
            ),
        ],
    )
...
def main():
    ...
    print("=" * 70)
    print("PARALLEL SCRAPER 2: 2014-2016")
    print("=" * 70)
    print("Date Range: 2014-01-01 to 2015-12-31")
    print("Strategy: 15-day batches, 500 results/page")
    print("=" * 70)
    print()
    
    scraper = BOEParallelScraper(scraper_id=2)
    
    try:
        progress = scraper.scrape_date_range(
            start_year=2014, start_month=1, start_day=1,
            end_year=2015, end_month=12, end_day=31,
            resume=True
        )
        
        print()
        print("=" * 70)
        print("✓ SCRAPER 2 COMPLETE (2014-2016)")
        print("=" * 70)
