/**
 * /resultados/{prov}/{muni}/{tipo}/{ano} — page N.
 *
...
type PageProps = { params: Promise<{ seg1: string; seg2: string; seg3: string; seg4: string; page: string }> };

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const { seg1, seg2, seg3, seg4, page } = await params;
