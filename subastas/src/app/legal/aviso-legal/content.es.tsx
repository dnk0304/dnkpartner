...
/**
 * /legal/aviso-legal — Spanish body (i18n Phase 2).
 *
 * Moved verbatim out of page.tsx so the page can switch bodies by locale.
 * The Spanish output is preserved exactly as it shipped at SHA 07cda37;
 * do NOT genericize the operator identity, Whop, the desistimiento clause
 * or the EU law-framing.
 */
