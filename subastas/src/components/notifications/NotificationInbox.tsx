        ...
        {(["all", "unread"] as Filter[]).map((f) => (
          <button
            ...
            className={cn(
              ...
              filter === f
                ? "bg-[var(--color-action-soft)] border border-[var(--color-action)] text-[var(--color-ink-primary)]"
                : "text-[var(--color-ink-primary)] hover:bg-[var(--color-surface-muted)]",
            )}
          >
  ...
  return (
    <div className="rounded-lg border border-dashed border-[#1F3A5F]/15 bg-white py-12 text-center">
      ...
      <div className="mt-4">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 h-9 px-4 rounded-md bg-[var(--color-action-soft)] border border-[var(--color-action)] text-[var(--color-ink-primary)] text-sm font-medium hover:bg-[var(--color-action-soft)]/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--color-action)]"
        >
          Explorar subastas
        </Link>
      </div>
